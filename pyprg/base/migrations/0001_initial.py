# Generated by Django 3.0.3 on 2020-02-05 22:01

from django.db import migrations, models
import django.utils.timezone
import pyprg.base.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this \
                user.', related_name='user_set', related_query_name='user', to='auth.Permission', verbose_name='user \
                permissions')),
            ],
            options={
                'verbose_name': 'user',
            ...
            managers=[
                ('objects', pyprg.base.models.UserManager()),
            ],
        ),
    ]
