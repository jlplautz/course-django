...
def resp(client, db):
    """
    - criar uma fixture resp (que via receber o client
      e tentar fazer uma chamada http neste client, justamente naquela url que foi apresentada 'login'
      vamos retorna o resultado desta fixture
      declarar aqui o decorator do pytest a fixture
    :return:
    """
